...
public class SpringSecurityDemoAppApplication {
	...
	protected void init() {
		...
		user.setUserName("RecycleSeekerTester");
		user.setFirstName("RecycleUserTester");
		user.setEmail("RecycleSeeker@gmail.com");
		user.setLastName("Tester");
		
		user.setPassword(passwordEncoder.encode("Testing1#2?"));
